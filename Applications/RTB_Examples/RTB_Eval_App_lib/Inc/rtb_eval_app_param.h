 ...
 */
#define DEFAULT_INITIATOR_LONG_ADDR_REMOTE  (0x0004251914001F3DUL)
#define DEFAULT_INITIATOR_SHORT_ADDR_REMOTE (0x0001)

/*
 * This is the reflector in a regular ranging procedure.
 */
#define DEFAULT_REFLECTOR_LONG_ADDR     (0x000425FFFF175D79UL)
#define DEFAULT_REFLECTOR_SHORT_ADDR    (0x0002)

/*
 * This is the reflector0 in a modified ranging procedure.
 */
#define DEFAULT_REFLECTOR0_LONG_ADDR     (0x0004251914001F3DUL)
#define DEFAULT_REFLECTOR0_SHORT_ADDR    (0x0003)

/*
 * This is the reflector1 in a modified ranging procedure.
 */
#define DEFAULT_REFLECTOR1_LONG_ADDR     (0x000425FFFF175D79UL)
#define DEFAULT_REFLECTOR1_SHORT_ADDR    (0x0004)

/*
 * This is the reflector2 in a modified ranging procedure.
 */
#define DEFAULT_REFLECTOR2_LONG_ADDR     (0x000425FFFF175D60UL)
#define DEFAULT_REFLECTOR2_SHORT_ADDR    (0x0005)

/*
 * This is the reflector3 in a modified ranging procedure.
 */
#define DEFAULT_REFLECTOR3_LONG_ADDR     (0x000425FFFF175DB4UL)
#define DEFAULT_REFLECTOR3_SHORT_ADDR    (0x0006)
...
/*
 * Keep this a value of power of 2 for inexpensive module operations
...
#define CONT_RANGING_PERIOD_MS          (75UL)
...
typedef enum node_type_tag
{
				 /* LED 0    LED 1     LED 2 */
    GENERAL,     /* off      off       off   */
    INITIATOR,   /* on       off       off   */
    REFLECTOR,   /* off      on        off   */
    COORDINATOR, /* on       on        off   */
    REFLECTOR0,  /* off      off       on    */
    REFLECTOR1,  /* on       off       on    */
    REFLECTOR2,  /* off      on        on    */
    REFLECTOR3   /* on       on        on    */
} SHORTENUM node_type_t;
#endif

/* Ranging addressing scheme type */
...
typedef enum filtering_method_tag
{
    ...
    FILT_MIN_VAR,   /**< Minimum of distance and DQF considering variance */
...
extern "C" {
    ...
    void handle_range_conf_z(uint8_t first,
						   uint8_t status,
						   uint32_t distance,
						   uint8_t dqf);
	...
	void set_own_short_addr( int own_short_address );
